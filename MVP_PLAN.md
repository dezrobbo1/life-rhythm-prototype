...
Status (2026-09-26): **Gate 8A1, 8A2 and 8A3 are merged. Gate 8A3 is under a bounded post-merge correctness correction.** Gate 8A1 merged as PR #157, Gate 8A2 as PR #158, and Gate 8A3 as PR #159 at `main` `5f0b7027dc60819fa9ea47cca1685c0f012cd64b`. Its correction must be reviewed and merged before Gate 8A4 begins. Gate 8B remains not started. The blocker inventory, slice ownership and trial start gate are in `app/docs/gate8a-personal-trial-platform-readiness.md`. Earlier PR #104-era personal-trial guidance is historical.
...
3. **8A3 — Availability + Calendar — Merged; post-merge correction in review:** reviewed usable-day setup and workday assignments, work-bound travel, safe static recurring calendar input, and settings repair. Blank calendar gaps never create capacity. See `app/docs/gate8a3-availability-calendar-report.md`.
