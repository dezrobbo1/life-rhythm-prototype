...
import { TaskPoolCaptureModal, type TaskPoolCaptureInput } from '../features/taskPool/TaskPoolCaptureModal';
...
export function PlanScreen() {
  ...
  return (
    <div className="screen-stack plan-screen">
      ...
      <Card>
        <section className="task-pool" aria-labelledby="task-pool-title">
