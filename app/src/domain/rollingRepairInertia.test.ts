...
describe('primary scheduler entry point', () => {
  it('uses the current Gate 5 primary scheduler while retaining Gate 4 rolling-repair behavior', () => {
    expect(primarySchedulerStatus).toBe('gate5-clock-aware-rolling-horizon');
