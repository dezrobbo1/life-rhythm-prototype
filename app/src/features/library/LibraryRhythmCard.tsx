  ...
  return (
    <article className="library-card" aria-labelledby={`${rhythm.id}-title`}>
      ...
      <div className="library-card__actions">
        ...
        {configuration.state === 'disabled' || configuration.state === 'paused' ? <Button disabled={actionsDisabled} onClick={() => onSetState(rhythm.id, 'enabled')} variant="primary">Turn on rhythm</Button> : null}
        ...
        <Button disabled={actionsDisabled} onClick={() => onAddToday(rhythm)}>{configured ? 'Add to Today once' : 'Configure to add once'}</Button>
